...
const Invest = () => {
        ...
        <Box>
            ...
            {allocationType === "glide" && (
                <>
                    <Box>
                        <Typography variant="body1" sx={{ marginBottom: 1, fontWeight: 'medium' }}>
                            Initial Investment Allocation Percentage
                        </Typography>
                        <TextField
                            type="number"
                            name="initial"
                    ...
                    <Box>
                        <Typography variant="body1" sx={{ marginBottom: 1, fontWeight: 'medium' }}>
                            Final Investment Allocation Percentage
                        </Typography>
                        <TextField
                            type="number"
                            name="final"
    ...
    <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <InvestList list={investments} handleMoveInvestment={handleMoveInvestment} />
    </Box>
</Box>
